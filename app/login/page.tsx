    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] flex flex-col items-center justify-center p-4">
            ...
            <div className="w-full max-w-[640px] flex flex-col items-start space-y-8">
                ...
                {/* CTA Button: Standard Google Style - Scaled */}
                <div className="w-full pt-6">
                    <button
                        onClick={() => signIn("google", { callbackUrl: "/pipelines" })}
                        className="w-full bg-white text-[#1f1f1f] border border-[#747775] h-16 rounded-full font-medium text-[20px] hover:bg-gray-50 hover:shadow-md transition-all flex items-center justify-center gap-4 relative"
                    >
                        {/* Google 'G' Logo */}
            ...
            {/* The bottom visual section has been completely removed to satisfy the "kill the bottom image" requirement. */}
        </div>
    )
}
