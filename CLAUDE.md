...
3. Phase 4c-4 — Overlay layout v2 + tier differentiation + upsell restoration. ✓ closed at <hash> (patches 1-9 rolled in; full detail in HANDOFF.md "Phase 4c shipped — archive")
